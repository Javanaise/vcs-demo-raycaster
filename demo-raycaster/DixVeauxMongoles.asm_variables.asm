...
; =====================================================================
tt_timer                equ $80 ;ds 1    ; current music timer value
tt_cur_pat_index_c0     equ $81 ;ds 1    ; current pattern index into tt_SequenceTable
tt_cur_pat_index_c1     equ $82 ;ds 1
tt_cur_note_index_c0    equ $83 ;ds 1    ; note index into current pattern
tt_cur_note_index_c1    equ $84 ;ds 1
tt_envelope_index_c0    equ $85 ;ds 1    ; index into ADSR envelope
tt_envelope_index_c1    equ $86 ;ds 1
tt_cur_ins_c0           equ $87 ;ds 1    ; current instrument
tt_cur_ins_c1           equ $88 ;ds 1
...
; =====================================================================
; moved it with global variables declaration
;tt_ptr                  equ $89 ;ds 2
